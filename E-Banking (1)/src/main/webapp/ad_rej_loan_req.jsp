...
<html>
<head>
<title>Rejected requests for loan application</title>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="96%" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="141" valign="top"><div align="center"><strong><font color="#996600">Account 
		...
		String query=new String("select name,acc_no,email,lid from loan_appln where sta=0");
        ...
        <tr> 
          ...
          <form name="f11" action="ad_rej_last_loan.jsp?id=1"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div>
            <div align="center"> </div></td>
          <form name="f12" action="ad_rej_last_loan.jsp?id=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f13" action="ad_rej_last_loan.jsp?id=3" method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f14" action="ad_rej_last_loan.jsp?id=4"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div>
            <div align="center"> </div></td>
          <form name="f15" action="ad_rej_last_loan.jsp?id=5"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div>
            <div align="center"> </div></td>
          <form name="f16" action="ad_rej_last_loan.jsp?id=6"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f17" action="ad_rej_last_loan.jsp?id=7"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div>
            <div align="center"> </div></td>
          <form name="f18" action="ad_rej_last_loan.jsp?id=8"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div>
            <div align="center"> </div></td>
          <form name="f19" action="ad_rej_last_loan.jsp?id=9"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div>
            <div align="center"> </div></td>
          <form name="f20" action="ad_rej_last_loan.jsp?id=10"  method="post">
            <td valign="top"><div align="center"> 
