...
//                        String q4="Update dd_req set dd_date='"+new java.util.Date()+"',dd_no=" + request.getParameter("hf_ddno1") + ",sta=2 where req_id=" + idu;
                        ...
                        String q4="Update cheque_req  SET sta=0 where id="+ idu;
			...
			// ends 
			// get Trans amnt
               String   subqry2="select amt from dd_req where req_id="+idu;
	...
	else
	{
		//query="Update dd_req set sta=0 where req_id=" + idu;
                query="Update cheque_req  SET sta=0 where id="+ idu;
