...
//	Savepoint spnt=con.setSavepoint();
	...
	String query="Delete from dd_req where req_id=" + idu;
	...
	out.print("<div align=center><a href=ad_rej_dd_req.jsp><img src=images/btn_back.gif width=90 height=30 border=0></a></div>");
