...
<html>
<head>
<title>Requests for new loan</title>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="96%" border="1" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="143" valign="top"><div align="center"><strong><font color="#996600">Account 
		...
		String query=new String("select lid,name,acc_no,email from loan_appln where sta=1");
		System.out.println("before executeQuery(query)");
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=1 " target="_blank"> 
              <% out.print(idu); %>
              </a></div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=1" target="_blank"> 
          ...
          <td valign="top"> <div align="center"> 
			...
			<form name="f1" action="ad_ser_loan_last.jsp?id=1&pro=1" method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit" value="Accept">
            </div></td>
			</form>
			<form name="f11" action="ad_ser_loan_last.jsp?id=1&pro=2"  method="post">
          <td valign="top"><div align="center"> 
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=2" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=2" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f2" action="ad_ser_loan_last.jsp?id=2&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit3" value="Accept">
            </div></td>
			</form><form name="f12" action="ad_ser_loan_last.jsp?id=2&pro=2"  method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=3" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center">  <a href="ad_req_loan_ser.jsp?id=3" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f3" action="ad_ser_loan_last.jsp?id=3&pro=1" method="post">
          <td valign="top"><div align="center"> 
                <input type="submit" name="Submit4" value="Accept">
            </div></td>
			</form><form name="f13" action="ad_ser_loan_last.jsp?id=3&pro=2" method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=4" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center">  <a href="ad_req_loan_ser.jsp?id=4" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f4" action="ad_ser_loan_last.jsp?id=4&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit7" value="Accept">
            </div></td>
			</form><form name="f14" action="ad_ser_loan_last.jsp?id=4&pro=2"  method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=5" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=5" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f5" action="ad_ser_loan_last.jsp?id=5&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit9" value="Accept">
            </div></td>
			</form><form name="f15" action="ad_ser_loan_last.jsp?id=5&pro=2"  method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=6" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=6" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f6" action="ad_ser_loan_last.jsp?id=6&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit11" value="Accept">
            </div></td>
			</form><form name="f16" action="ad_ser_loan_last.jsp?id=6&pro=2"  method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=7" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=7" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f7" action="ad_ser_loan_last.jsp?id=7&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit13" value="Accept">
            </div></td>
			</form><form name="f17" action="ad_ser_loan_last.jsp?id=7&pro=2"  method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=8" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=8" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f8" action="ad_ser_loan_last.jsp?id=8&pro=1"  method="post">
          <td valign="top"><div align="center"> 
                <input type="submit" name="Submit15" value="Accept">
            </div></td>
			</form><form name="f18" action="ad_ser_loan_last.jsp?id=8&pro=2"  method="post">
          <td valign="top"><div align="center">
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=9" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center"> <a href="ad_req_loan_ser.jsp?id=9" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f9" action="ad_ser_loan_last.jsp?id=9&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit17" value="Accept">
            </div></td>
			</form><form name="f19" action="ad_ser_loan_last.jsp?id=9&pro=2"  method="post">
          <td valign="top"><div align="center"> 
		...
		%>
        <tr> 
          <td valign="top"> <div align="center"> <a href="ad_req_loan_ser.jsp?id=10" target="_blank"> 
              <% out.print(idu); %>
              </a> </div></td>
          <td valign="top"><div align="center">  <a href="ad_req_loan_ser.jsp?id=10" target="_blank"> 
              <% out.print(rs.getString(2)); %></a>
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
			<form name="f10" action="ad_ser_loan_last.jsp?id=10&pro=1"  method="post">
          <td valign="top"><div align="center">
<input type="submit" name="Submit19" value="Accept">
            </div></td>
			</form><form name="f20" action="ad_ser_loan_last.jsp?id=10&pro=2"  method="post">
          <td valign="top"><div align="center">
