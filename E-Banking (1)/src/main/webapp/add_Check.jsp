...
function ib(no)
{
	...
	{
		ddno=prompt("Enter the Check Starting Number",0,"DD Number");
                ddno2=prompt("Enter the Check Ending Number",0,"DD Number");
	}
	switch(no)
	{
	case 1: 
...
System.out.println("select f_name from reg_info where reg_id=" + req_id);
	...
	%>
        <tr> 
            <td valign="top"> <div align="center"> <%--<a href="ad_req_dd_ser2.jsp?id=1&name=<%= ev%>"> --%>
              <% out.print(idu); %>
              </a></div></td>
              <td valign="top"><div align="center"> <%--<a href="ad_req_dd_ser2.jsp?id=1&name=<%= ev%>" > --%> 
              <%   out.print(ev);  %>
...
<div align="center">
          ...
          <form name="f12" action="ad_ser_dd_last22.jsp?id=2&pro=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f13" action="ad_ser_dd_last22.jsp?id=3&pro=2" method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f14" action="ad_ser_dd_last22.jsp?id=4&pro=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f15" action="ad_ser_dd_last22.jsp?id=5&pro=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f16" action="ad_ser_dd_last22.jsp?id=6&pro=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f17" action="ad_ser_dd_last22.jsp?id=7&pro=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <td valign="top"> <div align="center"> 
            ...
            <div align="center"></div></td>
          <form name="f8" action="ad_ser_dd_last22.jsp?id=8&pro=1"  method="post" onSubmit="return ib(8)">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f19" action="ad_ser_dd_last22.jsp?id=9&pro=2"  method="post">
            <td valign="top"><div align="center"> 
        ...
        <tr> 
          ...
          <form name="f20" action="ad_ser_dd_last22.jsp?id=10&pro=2"  method="post">
            <td valign="top"><div align="center"> 
