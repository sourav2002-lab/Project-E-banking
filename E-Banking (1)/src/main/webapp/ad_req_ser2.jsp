...
<html>
<head>
<title>Rejected user details</title>
	...
	%>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="320" valign="top"><div align="center"><strong><font color="#CC6633"> 
        ...
        <tr> 
          <td height="72" colspan="2" valign="top"> <table width="100%" height="58" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td height="24"></td>
                <td valign="top"><form name="form1" action="ad_new_req_nacc.jsp"><input type="submit" name="Submit" value="      Back     " ></form></td>
                <td></td>
              </tr>
              <tr> 
                <td height="19"></td>
